//
//  ApplicationListViewControllerViewModel.swift
//
...
class ApplicationListViewControllerViewModel: BaseViewModel {
    ...
    func fetchJobs() {
        ...
        self.apiService.fetchMyApplications(page: page) {[weak self] (result) in
            if self?.page == 1 {
