...
class ApplicationListViewController: BaseViewController {
    private var viewModel: ApplicationListViewControllerViewModel?
...
extension ApplicationListViewController {
    public class func build(viewModel: ApplicationListViewControllerViewModel) -> ApplicationListViewController {
        let controller = ApplicationListViewController(nibName: "ApplicationListViewController", bundle: nil)
